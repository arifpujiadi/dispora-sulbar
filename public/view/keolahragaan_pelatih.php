...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/custom/keolahragaan_pelatih.css">
    </head>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table class="table table-history col-md-12 col-sm-12 col-xs-12 font-RobotoCondensed-Light">
                                            <tr class="grey-tableTr font-LatoLight">
                                                ...
                                                <td class="title-table title-table-1 title-3">Cabang Olahraga</td>
                                                <td class="title-table title-table-2 title-4">Nama</td>
                                                <td class="title-table title-table-1 title-5">Alamat</td>
                                                <td class="title-table title-table-2 title-6">Lisensi</td>
                                            </tr>
                                            <tr>
