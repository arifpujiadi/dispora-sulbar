...
<html>
    <head>
        <title>Lembaga Pengelola</title>
        <!--css-->
        <!--==================================================-->
        <?php include '_css.php'; ?>
        <link rel="stylesheet" href="../css/custom/tablePage.css">
        <link rel="stylesheet" href="../css/custom/keolahragaan_lembagaPengelola.css">
    </head>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-titleTop">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="col-md-6 col-sm-6 col-xs-12 boxOut-primaryTitleTop font-oswaldBold text-uppercase">
                                                LEMBAGA PENGELOLA
                                            </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table class="table table-history col-md-12 col-sm-12 col-xs-12 font-RobotoCondensed-Light">
                                            <tr class="grey-tableTr font-LatoLight">
                                                ...
                                                <td class="title-table title-table-2 title-2">Nama Organisasi</td>
                                                <td class="title-table title-table-1 title-3">Ketua</td>
                                                <td class="title-table title-table-2 title-4">Wakil Ketua</td>
                                                <td class="title-table title-table-1 title-5">Sekretaris</td>
                                                <td class="title-table title-table-2 title-6">Alamat</td>
                                                <td class="title-table title-table-1 title-7">Periode</td>
                                            </tr>
                                            <tr>
