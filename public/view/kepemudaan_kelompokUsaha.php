...
<html>
    <head>
        <title>Kelompok Usaha</title>
        <!--css-->
        <!--==================================================-->
        <?php include '_css.php'; ?>
        <link rel="stylesheet" href="../css/custom/tablePage.css">
        <link rel="stylesheet" href="../css/custom/kepemudaan_kelompokUsaha.css">
    </head>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table class="table table-history col-md-12 col-sm-12 col-xs-12 font-RobotoCondensed-Light">
                                            <tr class="grey-tableTr font-LatoLight">
                                                ...
                                                <td class="title-table title-table-2 title-2">Nama Kelompok</td>
                                                <td class="title-table title-table-1 title-3">Nama Ketua</td>
                                                <td class="title-table title-table-2 title-4">Alamat</td>
                                                <td class="title-table title-table-1 title-5">Kabupaten</td>
                                                <td class="title-table title-table-2 title-6">Periode</td>
                                            </tr>
                                            <tr>
