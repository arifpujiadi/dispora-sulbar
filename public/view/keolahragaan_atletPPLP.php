                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table class="table table-history col-md-12 col-sm-12 col-xs-12 font-RobotoCondensed-Light">
                                            <tr class="grey-tableTr font-LatoLight">
                                                ...
                                                <td class="title-table title-table-2 title-4">J. Kelamin</td>
                                                <td class="title-table title-table-1 title-5">Alamat</td>
                                                <td class="title-table title-table-2 title-6">Kab./Kota/Kec</td>
                                                <td class="title-table title-table-1 title-7">Cabang Olahraga</td>
                                                <td class="title-table title-table-2 title-8">Prestasi</td>
                                                <td class="title-table title-table-1 title-9">Periode</td>
                                            </tr>
                                            <tr>
