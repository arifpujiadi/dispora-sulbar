...
<html>
    <head>
        <title>Data PPAP</title>
        <!--css-->
        <!--==================================================-->
        <?php include '_css.php'; ?>
        <link rel="stylesheet" href="../css/custom/tablePage.css">
        <link rel="stylesheet" href="../css/custom/kepemudaan_dataPPAP.css">
    </head>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table class="table table-history col-md-12 col-sm-12 col-xs-12 font-RobotoCondensed-Light">
                                            <tr class="grey-tableTr font-LatoLight">
                                                ...
                                                <td class="title-table title-table-2 title-4">Asal Sekolah</td>
                                                <td class="title-table title-table-1 title-5">Penempatan</td>
                                                <td class="title-table title-table-2 title-6">Alamat</td>
                                                <td class="title-table title-table-1 title-7">Kabupaten</td>
                                                <td class="title-table title-table-2 title-8">Periode</td>
                                            </tr>
                                            <tr>
