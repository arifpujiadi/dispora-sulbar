...
<html>
    <head>
        <title>Data SP3OR</title>
        <!--css-->
        <!--==================================================-->
        <?php include '_css.php'; ?>
        <link rel="stylesheet" href="../css/custom/tablePage.css">
        <link rel="stylesheet" href="../css/custom/keolahragaan_datasp3or.css">
    </head>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table class="table table-history col-md-12 col-sm-12 col-xs-12 font-RobotoCondensed-Light">
                                            <tr class="grey-tableTr font-LatoLight">
                                                ...
                                                <td class="title-table title-table-1 title-3">Jenis Kegiatan</td>
                                                <td class="title-table title-table-2 title-4">Penempatan</td>
                                                <td class="title-table title-table-1 title-5">Tahun</td>
                                                <td class="title-table title-table-2 title-6">Kab./Kota</td>
