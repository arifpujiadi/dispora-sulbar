...
<html>
    <head>
        <title>Unduh Berkas Keolahragaan</title>
        <!--css-->
        <!--==================================================-->
        <?php include '_css.php'; ?>
        <link rel="stylesheet" href="../css/custom/unduhBerkasKeolahragaan.css">
    </head>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-titleTop">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="col-md-4 col-sm-12 col-xs-12 boxOut-primaryTitleTop font-oswaldBold text-uppercase">
                                                UNDUH BERKAS KEOLAHRAGAAN
                                            </div>
                                            <div class="col-md-8 col-sm-12 col-xs-12 boxOut-searchBox font-LatoLight">
