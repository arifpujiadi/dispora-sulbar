...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/custom/kepemudaan_saranaPrasarana.css">
    </head>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table class="table table-history col-md-12 col-sm-12 col-xs-12 font-RobotoCondensed-Light">
                                            <tr class="grey-tableTr font-LatoLight">
                                                ...
                                                <td class="title-table title-table-2 title-4">Jenis</td>
                                                <td class="title-table title-table-1 title-5">Alamat</td>
                                                <td class="title-table title-table-2 title-6">Kepemilikan</td>
                                                <td class="title-table title-table-1 title-7">Kondisi</td>
                                                <td class="title-table title-table-2 title-8">Kabupaten</td>
